 ...
 * @constructor
 * @class Class to render a cell containing a datetime
 */

function DatetimeCellRenderer(config) { this.init(config); }
DatetimeCellRenderer.prototype = new CellRenderer;

DatetimeCellRenderer.prototype.render = function(cell, value)
{
    var datetime = this.editablegrid.checkDatetime(value);
    if (typeof datetime == "object") cell.innerHTML = datetime.formattedDatetime;
    else cell.innerHTML = value;
};
