...
/**
 * Datetime cell validator
 * @constructor
 * @augments CellValidator
 * @class Class to validate a cell containing a datetime
 */

function DatetimeCellValidator(grid) { this.grid = grid; }
DatetimeCellValidator.prototype = new CellValidator;

DatetimeCellValidator.prototype.isValid = function(value)
{
    return value == "" || typeof this.grid.checkDatetime(value) == "object";
};
